...
<body class="gradient-bg min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md login-container animate-fadeIn">
            ...
            <form id="loginForm" class="space-y-6">
                <div>
                    ...
                    <p class="text-xs text-gray-500 mt-2">
                        💡 Test Account: <span class="font-semibold">TEST001</span>
                    </p>
                </div>
                ...
                <div class="flex items-start space-x-3 text-sm text-gray-600">
                    ...
                    <div>
                        ...
                        <ul class="list-disc list-inside space-y-1 text-xs">
                            <li>Only authorized students can access the quiz</li>
                            <li>Ensure stable internet connection</li>
                            <li>Camera access will be requested for proctoring</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="text-center mt-6 text-white/80 text-sm">
            <p>&copy; 2025 Web Development Quiz System</p>
        </div>
    </div>
